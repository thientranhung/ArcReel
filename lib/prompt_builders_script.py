...
{title_line}{_format_outline_lines(previous_episode_outline)}
        ...
        parts.append(_OPENING_BRIDGE_GUIDE)
    if episode_outline:
...
def build_normalize_prompt(
    ...
    ``previous_episode_outline``（第二集起）驱动开场用画外音承接上集预告 / 钩子。
    ...
    outline_block = _format_episode_outline_block(episode_outline, next_episode_outline, previous_episode_outline)
