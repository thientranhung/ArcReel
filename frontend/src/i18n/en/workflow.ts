export default {
  ...
  'cost_estimate_warn': 'Estimated cost: {{cost}}',
  'cost_estimate_confirm': 'Estimated cost {{cost}} is above the project cost threshold — confirm to proceed.',
  'cost_estimate_unpriced_one': '({{count}} unit has no known price)',
  'cost_estimate_unpriced_other': '({{count}} units have no known price)',
