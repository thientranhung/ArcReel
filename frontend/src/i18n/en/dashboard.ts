...
export default {
  ...
  'custom_style_text_section_title': 'Custom style text',
  'custom_style_text_section_desc': 'Write a longer custom style description (e.g. a bespoke Pixar/DreamWorks style block). Mutually exclusive with the built-in template and uploaded reference image — saving detaches from the current template/reference image and uses this text as the style prompt.',
  'custom_style_text_placeholder': 'e.g. 3D Pixar-style rendering, soft volumetric lighting, rounded character shapes, warm color palette…',
  'custom_style_text_detached_from_template': 'Currently showing the expanded text of template "{{template}}" (read-only). Click "Detach and edit" to switch to custom text.',
  'custom_style_text_detach_button': 'Detach and edit',
  'custom_style_text_save': 'Save custom style',
  'custom_style_text_saving': 'Saving…',
  'custom_style_text_empty_error': 'Custom style text cannot be empty',
  'importing': 'Importing...',
  ...
  'audience_desc': 'Injected into script, asset, storyboard, and video prompts; no effect when left empty',
  'audience_label': 'Audience',
  'audience_placeholder': 'kids 6-10 / 儿童 6-10 岁 / trẻ em 6-10 tuổi',
  'audience_hint': 'Free text; leave empty to leave unset. Kid-audience cues switch the script to kid-friendly rules',
