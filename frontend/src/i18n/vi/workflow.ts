...
export default {
  ...
  'cost_estimate_warn': 'Chi phí ước tính: {{cost}}',
  'cost_estimate_confirm': 'Chi phí ước tính {{cost}} vượt ngưỡng chi phí của dự án — xác nhận để tiếp tục.',
  'cost_estimate_unpriced_one': '(còn {{count}} đơn vị chưa xác định được giá)',
  'cost_estimate_unpriced_other': '(còn {{count}} đơn vị chưa xác định được giá)',
