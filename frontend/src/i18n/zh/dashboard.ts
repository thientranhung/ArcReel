...
export default {
  ...
  'custom_style_text_section_title': '自定义风格文本',
  'custom_style_text_section_desc': '写一段较长的自定义风格描述（如定制 Pixar/DreamWorks 风格），与内置模版、上传参考图互斥；保存后将脱离当前模版/参考图，改用这段文本作为风格提示词。',
  'custom_style_text_placeholder': '例如：3D 皮克斯风格渲染，柔和体积光，圆润角色造型，暖色调……',
  'custom_style_text_detached_from_template': '当前展示的是模版「{{template}}」展开后的文本（只读）。点击「脱离模版编辑」后可修改为自定义文本。',
  'custom_style_text_detach_button': '脱离模版编辑',
  'custom_style_text_save': '保存自定义风格',
  'custom_style_text_saving': '保存中…',
  'custom_style_text_empty_error': '自定义风格文本不能为空',
  'importing': '导入中...',
  'import_zip': '导入 ZIP',
  ...
  'audience_title': '目标受众',
  'audience_desc': '写入脚本、资产、分镜与视频提示词；留空则不生效',
  'audience_label': '目标受众',
  'audience_placeholder': '儿童 6-10 岁 / kids 6-10 / trẻ em 6-10 tuổi',
  'audience_hint': '自由文本，留空使用未设默认；命中儿童线索词时脚本会启用儿童向创作规则',
