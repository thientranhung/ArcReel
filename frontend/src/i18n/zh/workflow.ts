...
export default {
  ...
  'cost_estimate_warn': '预估费用：{{cost}}',
  'cost_estimate_confirm': '预估费用 {{cost}} 超过项目费用阈值，需确认后才能继续。',
  'cost_estimate_unpriced_one': '（另有 {{count}} 个 unit 无法定价）',
  'cost_estimate_unpriced_other': '（另有 {{count}} 个 unit 无法定价）',
  'tier_unknown': '档位待定',
